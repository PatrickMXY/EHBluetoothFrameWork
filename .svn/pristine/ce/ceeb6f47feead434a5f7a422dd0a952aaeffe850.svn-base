...
static int TEA_ROUND = 8;
static unsigned int TEA_DELTA = 2654435769;

static unsigned int _FixKeys[] = {37632979,77198367};

static NSString *SessionFixKey = @"easthouse4009977880";
